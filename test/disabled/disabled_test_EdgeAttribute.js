...
// Globals.
//
const example_id = 'edges/86ec2630408d3b6ef1073c4e8dfb5eeb';
const example_collection = 'edges';
const other_id = 'schemas/3e3d5e71d9654933b0454fb23fa14cb3';
const other_collection = 'schemas';
...
describe( "EdgeAttribute class tests:", function ()
{
	...
	describe( "Instantiation:", function ()
	{
		...
		//
		it( "Instantiate with wrong type of edge:", function ()
		{
			let doc;
			let func;
			...
			func = () => {
				doc =
					new TestClass(
						param.request, other_id, other_collection
					);
			};
			expect( func, "Instantiation" )
				.to.throw( MyError, /not an attribute edge/ );
		});
